...
from eth.vm.forks.the_merge import (
    TheMergeVM,
)
from eth.vm.forks.the_merge.blocks import (
    TheMergeBlockHeader as BlockHeader,
)
...
def mk_header_chain(base_header, length):
    ...
    for _ in range(length):
        ...
        next_header = TheMergeVM.create_header_from_parent(
            previous_header,
